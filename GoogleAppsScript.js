...
function handleRegister(data) {
  ...
  try {
    ...
    // ตรวจสอบความถูกต้องของสถานที่จัดงาน
    ...
    // ระบบอนุญาตให้ลงทะเบียนล่วงหน้า (Waitlist) ได้เมื่อโควต้าเต็ม โดยจะจัดสิทธิ์คิวที่หน้าบ้าน
    /*
...
function handleUpdate(data) {
  ...
  try {
    ...
    if (oldSite !== site) {
      ...
      // ระบบอนุญาตให้ย้ายสถานที่ดูงานมายังที่เต็มแล้วได้ โดยจะจัดเป็นคิวสำรอง (Waitlist) ที่หน้าบ้าน
      /*
      if (currentCount >= quota) {
